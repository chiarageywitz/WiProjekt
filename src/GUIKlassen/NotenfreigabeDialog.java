...
/**
 * GUI für die Freigabe von Noten nach Ablauf der Notenfrist. Nur für den
 * Studiendekan verfügbar.
 *
 * Zeigt eine Bestätigungsmeldung an und ermöglicht das Freigeben aller Noten an
 * die Studenten.
 */
public class NotenfreigabeDialog extends JFrame {

	/**
	 * Erstellt das Notenfreigabe-Fenster. Baut Header, Informationsbereich und
	 * Buttons auf.
	 */
	public NotenfreigabeDialog() {
		...
		// Center Panel mit Info-Text
		JPanel centerPanel = new JPanel();
		centerPanel.setLayout(new BoxLayout(centerPanel, BoxLayout.Y_AXIS));
		centerPanel.setBackground(Color.WHITE);
		centerPanel.setBorder(BorderFactory.createEmptyBorder(30, 30, 30, 30));

		JLabel infoLabel = new JLabel("<html><center>" + "Durch die Freigabe werden alle eingetragenen Noten<br>"
				+ "an die Studenten verschickt.<br><br>" + "Diese Aktion kann nicht rückgängig gemacht werden.<br><br>"
				+ "Möchten Sie fortfahren?" + "</center></html>");
	...
	/**
	 * Führt die Freigabe aller Noten durch. Zeigt eine Bestätigungsmeldung an und
	 * benachrichtigt alle Studenten. Bei Fehlern wird eine Fehlermeldung angezeigt.
	 */
	private void notenFreigeben() {
		...
		if (confirm == JOptionPane.YES_OPTION) {
			try {
				...
				ex.printStackTrace();
				JOptionPane.showMessageDialog(this, "Fehler beim Freigeben der Noten: " + ex.getMessage(), "Fehler",
