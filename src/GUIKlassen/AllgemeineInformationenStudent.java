...
/**
 * JPanel für die Anzeige und Eingabe allgemeiner Informationen eines Studenten
 * bezüglich seiner Bachelorarbeit.
 */
public class AllgemeineInformationenStudent extends JPanel {
	...
	/**
     * Hilfsmethode zum Hinzufügen eines Textfeldes mit Label.
     *
     * @param label Text des Labels
     * @param y     Vertikale Position
     * @return JTextField zum Ausfüllen
     */
	...
	private void speichern() {
		try {
			AllgemeineInformationenDAO.speichern(mnr, tfThema.getText(), tfUnternehmen.getText(), tfZeitraum.getText(),
					tfBetreuerHFT.getText(), tfBetreuerUnternehmen.getText(), cbNdaJa.isSelected(),
					tfNdaPfad.getText());

			JOptionPane.showMessageDialog(this, "<html><center>Daten erfolgreich gespeichert!</center></html>",
