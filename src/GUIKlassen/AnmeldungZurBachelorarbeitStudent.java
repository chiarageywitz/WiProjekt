...
/**
 * GUI für die Anmeldung zur Bachelorarbeit durch den Studenten.
 * Enthält Pflichtfelder, Checkboxen, Datumsauswahl und Buttons zum Absenden.
 */
        ...
        absendenBtn.addActionListener(e -> {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(this,
                        "Ihre Anmeldung zur Bachelorarbeit wurde erfolgreich übermittelt! Ihr Betreuer wurde benachrichtigt.",
